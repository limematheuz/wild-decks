...
export const COPY = {
  en: {
    ...
    modes: {
      clasico: { label: "DRUNKEN SUECA", description: "104 cards. Two decks. No jokers.", rulesTitle: "Drunken Sueca rules", rules: ["Play with two full decks: 104 cards, no jokers.", "Nobody leaves the game in the middle of a round.", "Draw a card and complete the action shown.", "Drink responsibly; non-alcoholic alternatives count too."], actions: classicActions },
      wild: { label: "WILD DECKS", description: "106 cards. Two jokers. No mercy.", rulesTitle: "Wild Decks rules", rules: ["Adults only. Keep it legal and agreed by everyone at the table.", "Challenges can be ruthless; no touching, private data or people outside the game without explicit consent.", "A clear pass is always valid: use the stated penalty or a non-alcoholic alternative.", "The table can veto anything unsafe. Consent is the one rule nobody breaks."], actions: wildActions }
    }
  },
  es: {
